...
<a class="navbar-brand mr-5 text-white font-weight-bold" href="/" style="font-size:24px"><i class="fa fa-film text-light"></i> FLEXPLAY</a>
...
<input type="text" name="story" class="form-control bg-white border-0 small" placeholder="Поиск фильмов, сериалов, мультфильмов ..." aria-label="Search" aria-describedby="basic-addon2">
<div class="input-group-append"><button class="btn bg-white" type="submit"><i class="fa fa-search fa-sm"></i></button></div>
</div>
</form>
...
[not-smartphone]<ul class="change-color navbar-nav ml-auto m-0 p-0" onclick="skinChange('Flexplay-dark');" title="Сменить цвет дизайна">
<li><span class="fa fa-moon-o"></span></li>
<li class="is-active"><span class="fa fa-sun-o"></span></li>
</ul>[/not-smartphone]
</div>
</div>
</nav>