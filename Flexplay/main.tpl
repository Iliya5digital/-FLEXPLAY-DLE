...
[available=cat]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">{category-title}</h1></div>[/available]
[available=feedback]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Наши контакты</h1></div>[/available]
[available=favorites]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Ваши закладки</h1></div>[/available]
[available=addnews]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Добавить фильм</h1></div>[/available]
[available=pm]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Личные сообщения</h1></div>[/available]
[available=alltags]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Облако тэгов</h1></div>[/available]
[available=tags]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Материалы по слову: {cloudstag}</h1></div>[/available]
[available=search]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Поиск по сайту</h1></div>[/available]
[available=lostpassword]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Восстановление пароля</h1></div>[/available]
[available=register]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Регистрация на сайте</h1></div>[/available]
[available=userinfo]<div class="col-lg-6 col-md-6"><h1 class="h5 mt-0 mb-0 text-dark">Страница пользователя</h1></div>[/available]
