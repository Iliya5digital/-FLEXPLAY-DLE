...
<div class="p-4 h-100 bg-white rounded overflow-hidden position-relative shadow">
<h4 class="h5 mt-0 mb-4 text-dark">Контакты</h4>
<h6 class="text-dark"><i class="fa fa-map pr-1"></i> Адрес :</h6>
<p class="pl-4">Россия, г. Москва, ул. Новая д. 123 офис 5888</p>
<h6 class="text-dark"><i class="fa fa-phone pr-1"></i> Телефон :</h6>
<p class="pl-4">+91 12345-67890, (+91) 123 456 7890</p>
<h6 class="text-dark"><i class="fa fa-fax pr-1"></i> Факс :</h6>
<p class="pl-4">(+20) 220 145 6589, +91 12345-67890</p>
<h6 class="text-dark"><i class="fa fa-envelope pr-1"></i> Email :</h6>
<p class="pl-4"><a href="#">email@russian.ru</a>, <a href="#">movieclub@russian.ru</a></p>
<h6 class="text-dark"><i class="fa fa-link fa-fw pr-1"></i> Сайт :</h6>
<p class="pl-4 mb-0">www.dle-theme.ru</p>
</div></div>
    
<div class="col-lg-8 col-md-8">
<div class="p-4 bg-white rounded overflow-hidden position-relative shadow">
<h4 class="h5 mt-0 mb-4 text-dark">Обратная связь</h4>
<div class="row">
