<section class="pt-5 pb-0 border-top">
<div class="container"><div class="p-4 bg-dark rounded overflow-hidden position-relative shadow mb-3">
...
<div class="h6 border-bottom mb-3 pb-3">Изменить информацию</div>
